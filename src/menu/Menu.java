...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
       // {"~MAIN~"},
        {"Dashboard"},
       // {"~WEB APP~"},
        {"DSA","Expression Converter (Stack)", "BST Generator", "AVL Tree Generator"},
        {"DLD","Base Converter","Maxterm/Minterm Converter","Kmap Solver"},
        {"Math","Gaussian elimination calculator","Inverse Matrix Calculator","Magnitude Calculator","Unit Vector Calculator","Vector Product","Scalar Product","Angle Finder","Scalar Triple Product"},
        {"Notpad"},
        {"Calculator"},
        {"Login"}
    };
    ...
    private final String headerName = "EduPulse";
